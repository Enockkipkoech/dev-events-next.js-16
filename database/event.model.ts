...
function generateSlug(title: string): string {
  ...
  // Remove special characters, convert to lowercase, and replace spaces with hyphens, replace multiple hyphens with a single one, and trim leading/trailing hyphens
  return title
    .toLowerCase()
